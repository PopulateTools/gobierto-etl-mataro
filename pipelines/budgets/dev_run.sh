...
cd $DEV_DIR/gobierto-etl-mataro/; ruby operations/gobierto_budgets/transform-executed/run.rb $WORKING_DIR/pressupost_2022_utf8_clean.csv $WORKING_DIR/budgets-executed-2022-transformed.json 2021
...
cd $DEV_DIR/gobierto-etl-mataro/; ruby operations/gobierto_budgets/transform-planned-updated/run.rb $WORKING_DIR/pressupost_2022_utf8_clean.csv $WORKING_DIR/budgets-planned-updated-2022-transformed.json 2021
