...
cd $DEV_DIR/gobierto-etl-utils/; ruby operations/check-csv/run.rb $WORKING_DIR/pressupost_2017_utf8_clean.csv
...
cd $DEV_DIR/gobierto-etl-mataro/; ruby operations/gobierto_budgets/transform-planned/run.rb $WORKING_DIR/pressupost_2017_utf8_clean.csv $WORKING_DIR/budgets-planned-2017-transformed.json 2017
...
cd $DEV_DIR/gobierto/; bin/rails runner $DEV_DIR/gobierto-etl-utils/operations/gobierto_budgets/annual_data/run.rb "2017 2018 2019" $WORKING_DIR/organization.id.txt
