...
# Transform > Transform planned budgets data files (estimación del presupuesto)
...
cd $DEV_DIR/gobierto-etl-mataro/; ruby operations/gobierto_budgets/transform-planned/run.rb $WORKING_DIR/avant_pressupost_2020_utf8_clean.csv $WORKING_DIR/budgets-planned-2020-transformed.json 2020
